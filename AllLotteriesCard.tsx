...
function SingleLotteryCard({ lottery }: { lottery: LotteryType }) {
  ...
  if (isLoading) {
    return (
      <div className="glass-card rounded-2xl animate-pulse p-6">
  ...
  return (
    <div
      style={{ border: isLive ? "1px solid rgba(239, 68, 68, 0.6)" : "1px solid rgba(255, 255, 255, 0.10)" }}
    ...
    return (
      <Card>
        ...
        <CardContent className="p-4 pt-0 space-y-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="glass-card rounded-2xl animate-pulse p-6">
              <div className="flex flex-col items-center gap-3">
