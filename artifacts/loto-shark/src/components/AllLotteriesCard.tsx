...
function SingleLotteryCard({ lottery }: { lottery: LotteryType }) {
  ...
  if (isLoading) {
    return (
      <div style={{ background: "rgba(255, 255, 255, 0.40)", border: "1px solid rgba(255, 255, 255, 0.55)" }} className="glass-card rounded-2xl animate-pulse p-6">
  ...
  return (
    <div
      style={{ background: "rgba(255, 255, 255, 0.40)", border: isLive ? "1px solid rgba(239, 68, 68, 0.6)" : "1px solid rgba(255, 255, 255, 0.55)" }}
      className={`glass-card rounded-2xl ${isLive ? "shadow-red-500/10 shadow-lg" : ""} transition-all duration-200 hover:shadow-xl ${cfg.accentGlow}`}
    ...
    return (
      <Card>
        ...
        <CardContent className="p-4 pt-0 space-y-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} style={{ background: "rgba(255, 255, 255, 0.40)", border: "1px solid rgba(255, 255, 255, 0.55)" }} className="glass-card rounded-2xl animate-pulse p-6">
              <div className="flex flex-col items-center gap-3">
